        ...
        <>
          ...
          <Field label={t("adapters.sessionStrategy")}>
            <select
              ...
              className={inputClass}
            >
              <option value="fixed">{t("adapters.sessionStrategyFixed")}</option>
              <option value="issue">{t("adapters.sessionStrategyPerIssue")}</option>
              <option value="run">{t("adapters.sessionStrategyPerRun")}</option>
            </select>
          </Field>
          ...
          <SecretField
            ...
            placeholder={t("adapters.gatewayAuthTokenPlaceholder")}
          />
          ...
          <Field label={t("adapters.scopesCommaList")}>
            <DraftInput
