            ...
            >
              <div className="min-w-0">
                ...
                <div className="text-xs text-muted-foreground">
                  {row.eventCount} {row.eventCount === 1 ? t("financeKindCard.event") : t("financeKindCard.events")} · {row.billerCount} {row.billerCount === 1 ? t("financeKindCard.biller") : t("financeKindCard.billers")}
                </div>
              </div>
