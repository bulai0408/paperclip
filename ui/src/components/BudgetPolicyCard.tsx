...
export function BudgetPolicyCard({
  ...
  const windowLabel = (windowKind: BudgetPolicySummary["windowKind"]) =>
    windowKind === "lifetime" ? t("budgetPolicy.lifetimeBudget") : t("budgetPolicy.monthlyUtcBudget");
  ...
  const observedBudgetGrid = isPlain ? (
    <div className="grid gap-6 sm:grid-cols-2">
      ...
      <div>
        ...
        <div className="mt-1 text-xs text-muted-foreground">
          {t("budgetPolicy.softAlertAt", { percent: summary.warnPercent })}{summary.paused && summary.pauseReason ? ` · ${summary.pauseReason} pause` : ""}
        </div>
      </div>
    </div>
  ) : (
