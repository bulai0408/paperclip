...
export function OnboardingWizard() {
  ...
  async function runAdapterEnvironmentTest(
    ...
    if (!createdCompanyId) {
      setAdapterEnvError(
        t("onboarding.createCompanyBeforeTest")
      );
      return null;
    }
  ...
  async function handleStep2Next() {
    ...
    try {
      if (adapterType === "opencode_local") {
        ...
        if (!selectedModelId) {
          setError(
            t("onboarding.openCodeModelRequired")
          );
          return;
        }
        ...
        if (!discoveredModels.some((entry) => entry.id === selectedModelId)) {
          setError(
            discoveredModels.length === 0
              ...
              : t("onboarding.openCodeModelUnavailable") + selectedModelId
          );
          return;
        }
      }
  ...
  async function handleUnsetAnthropicApiKey() {
    ...
    try {
      ...
      if (result?.status === "fail") {
        setError(
          t("onboarding.retriedAnthropicKeyUnset")
        );
      }
    } catch (err) {
      setError(
              ...
              {step === 1 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("onboarding.companySetup.title")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("onboarding.companySetup.description")}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    ...
                    >
                      {t("onboarding.companySetup.missionLabel")}
                    </label>
                    <textarea
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50 resize-none min-h-[60px]"
                      placeholder={t("onboarding.companySetup.missionPlaceholder")}
                      value={companyGoal}
              ...
              {step === 2 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("onboarding.agentSetup.title")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("onboarding.agentSetup.description")}
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder={t("onboarding.agentSetup.namePlaceholder")}
                      value={agentName}
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-2 block">
                      {t("onboarding.agentSetup.adapterType")}
                    </label>
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        {[
                          ...
                          },
                          {
                            ...
                            comingSoon: true,
                            disabledLabelKey: "adapters.configureInApp"
                          }
                        ].map((opt) => (
                          <button
                            key={opt.value}
                            ...
                            <span className="text-muted-foreground text-[10px]">
                              {opt.comingSoon
                                ? t((opt as { disabledLabelKey?: string })
                                    .disabledLabelKey ?? "adapters.comingSoon")
                                : t(opt.descKey)}
                            </span>
                          </button>
                        ))}
              ...
              {step === 4 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">{t("onboarding.readyToLaunch.title")}</h3>
                      <p className="text-xs text-muted-foreground">
                        {t("onboarding.readyToLaunch.description")}
                      </p>
                    </div>
                  </div>
                  <div className="border border-border divide-y divide-border">
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("onboarding.steps.company")}</p>
                      </div>
                    ...
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("onboarding.steps.task")}</p>
                      </div>
                      <Check className="h-4 w-4 text-green-500 shrink-0" />
                    </div>
                  </div>
