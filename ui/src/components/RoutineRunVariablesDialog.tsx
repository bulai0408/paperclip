  ...
  return (
    <Dialog open={open} onOpenChange={(next) => !isPending && onOpenChange(next)}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>{t("routines.runRoutine")}</DialogTitle>
          <DialogDescription>
            {t("routines.fillVariables")}
          </DialogDescription>
        </DialogHeader>
            ...
            <div key={variable.name} className="space-y-1.5">
              ...
              {variable.type === "textarea" ? (
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="__unset__">{t("common.noValue")}</SelectItem>
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder={t("routines.chooseValue")} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="__unset__">{t("common.noValue")}</SelectItem>
        ...
        <DialogFooter showCloseButton={false}>
          {missingRequired.length > 0 ? (
            <p className="mr-auto text-xs text-amber-600">
              {t("routines.missing")}{missingRequired.join(", ")}
            </p>
          ) : workspaceSelectionEnabled && !workspaceConfigValid ? (
            <p className="mr-auto text-xs text-amber-600">
              {t("routines.chooseWorkspace")}
            </p>
          ) : (
          ...
          >
            {isPending ? t("routines.running") : t("routines.runRoutine")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
