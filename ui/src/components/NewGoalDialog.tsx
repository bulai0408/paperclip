...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t("dialog.newGoal.goalType.company"),
    team: t("dialog.newGoal.goalType.team"),
    agent: t("dialog.newGoal.goalType.agent"),
    task: t("dialog.newGoal.goalType.task"),
  };
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("dialog.newGoal.newSubGoal") : t("dialog.newGoal.title")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("dialog.newGoal.titlePlaceholder")}
            value={title}
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("dialog.newGoal.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("dialog.newGoal.parentGoal")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("dialog.newGoal.creating") : newGoalDefaults.parentId ? t("dialog.newGoal.createSubGoal") : t("dialog.newGoal.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
