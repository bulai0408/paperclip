...
export function NewProjectDialog() {
  ...
  const projectStatuses = [
    ...
    { value: "in_progress", label: t("projectStatus.in_progress") },
    { value: "completed", label: t("projectStatus.completed") },
    { value: "cancelled", label: t("projectStatus.cancelled") },
  ];
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{t("dialog.newProject.title")}</span>
          </div>
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("dialog.newProject.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={goalOpen} onOpenChange={setGoalOpen}>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {selectedGoals.length > 0 ? t("dialog.newProject.addGoal") : t("dialog.newProject.goal")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border">
          {createProject.isError ? (
            <p className="text-xs text-destructive">{t("dialog.newProject.failedToCreate")}</p>
          ) : (
            <span />
          )}
          <Button
          ...
          >
            {createProject.isPending ? t("dialog.newProject.creating") : t("dialog.newProject.createProject")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
