  ...
  return (
    <>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("outputFeedback.consentTitle")}</DialogTitle>
            <DialogDescription>
              {t("outputFeedback.consentDescription")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              {t("outputFeedback.consentLocalNote")}
            </p>
            <p>
              {t("outputFeedback.consentChooseNote", {
                alwaysAllow: t("outputFeedback.alwaysAllow"),
                dontAllow: t("outputFeedback.dontAllow"),
              })}
            </p>
            <p>
              {t("outputFeedback.consentChangeNote")}
            </p>
            {termsUrl ? (
              <a
                href={termsUrl}
