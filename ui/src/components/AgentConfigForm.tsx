                  ...
                  {adapterType === "codex_local" &&
                    ...
                    currentThinkingEffort === "minimal" && (
                      <p className="text-xs text-amber-400">
                        {t("agentConfig.codexMinimalThinkingWarning")}
                      </p>
                    )}
                </>
              )}
        ...
        return (
          <div key={i} className="flex items-center gap-1.5">
            <input
              ...
              placeholder={t("agentConfig.keyPlaceholder")}
              value={row.key}
            ...
            {row.source === "secret" ? (
              ...
              <>
                ...
                <button
                  ...
                  onClick={() => sealRow(i)}
                  disabled={!row.key.trim() || !row.plainValue}
                  title={t("agentConfig.sealAsSecret")}
                >
                  {t("agentConfig.seal")}
                </button>
              </>
            ...
            {filteredModels.length === 0 && !canCreateManualModel && (
              <div className="px-2 py-2 space-y-2">
                <p className="text-xs text-muted-foreground">
                  {onDetectModel
                    ? t("agentConfig.noHermesModelDetected")
...
function ThinkingEffortDropdown({
  ...
  return (
    <Field label={t("agentConfig.thinkingEffortLabel")} hint={help.thinkingEffort}>
