...
export function IssuesList({
  ...
  const quickFilterPresets = [
    { label: t("issuesList.all"), statuses: [] as string[] },
    { label: t("issuesList.active"), statuses: ["todo", "in_progress", "in_review", "blocked"] },
    { label: t("issuesList.backlog"), statuses: ["backlog"] },
    { label: t("issuesList.done"), statuses: ["done", "cancelled"] },
  ];
