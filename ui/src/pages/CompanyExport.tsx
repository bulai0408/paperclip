  ...
  const exportPreviewMutation = useMutation({
    ...
    onError: (err) => {
      pushToast({
        ...
        body: err instanceof Error ? err.message : t("companyExport.loadExportDataFailed"),
      });
    },
  });
  ...
  const downloadMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      pushToast({
        ...
        body: t("companyExport.exportDownloadedDetail", { count: resultCheckedFiles.size, rootPath: result.rootPath }),
      });
    },
    onError: (err) => {
      pushToast({
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-4 text-sm">
            <span className="font-medium">
              {t("companyExport.exportTitle", { name: selectedCompany?.name ?? t("companyExport.company") })}
            </span>
