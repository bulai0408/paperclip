  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : t("routines.routineRunFailed"),
        tone: "error",
      });
    },
  });
              ...
              <div className="overflow-x-auto overscroll-x-contain">
                <div className="inline-flex min-w-full flex-wrap items-center gap-2 text-sm text-muted-foreground sm:min-w-max sm:flex-nowrap">
                  ...
                  <InlineEntitySelector
                    ...
                    noneLabel={t("common.noAssignee")}
                    searchPlaceholder={t("common.searchAssignees")}
                    emptyMessage={t("common.noAssigneesFound")}
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="text-left text-xs text-muted-foreground border-b border-border">
                  ...
                  <th className="px-3 py-2 font-medium">{t("onboarding.steps.agent")}</th>
                        ...
                        <div className="min-w-[180px]">
                          ...
                          {(isArchived || routine.status === "paused") && (
                            <div className="mt-1 text-xs text-muted-foreground">
                              {isArchived ? t("common.archived") : t("status.paused")}
                            </div>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-3 py-2.5" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {isArchived ? t("common.archived") : enabled ? t("common.on") : t("common.off")}
                          </span>
                        </div>
                      </td>
